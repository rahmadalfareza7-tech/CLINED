...
function show(id, options={}){
  ...
  if(id==="blokSspPage"){setCurrentBlockId("SSP"); try{renderBanks();renderCounts();renderModes();}catch(e){console.error("SSP render error",e);}}
...
function renderBanks(){
  ...
  const banks=Object.fromEntries(Object.entries(BANKS||{}).map(([id,b])=>[id,{name:b.name,desc:`${(b.data||[]).length} soal`} ]));
