/* CLINED New Features: Leaderboard, Study Timer, Question Notes */
'use strict';
...
window.CLINED_Leaderboard = (function () {
  ...
  // Jangan fetch leaderboard otomatis saat boot. Muat hanya ketika halaman/fitur leaderboard dibuka.
